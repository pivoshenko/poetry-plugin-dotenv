...
- **poetry**: Update dev dependencies
  ([`05a53a1`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/05a53a139579480fc416f4c382f95c30f98f766b))

### Chores

- **ruff**: Update config
  ([`c10ab78`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/c10ab78dc883dd6916c7924648c2c9a1782df1db))

### Code Style

- **CHANGELOG**: Run formatters
  ([`1ebd4f0`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/1ebd4f09854dd3b4abc9e8e4ad5e65d1b377c518))

- **poetry**: Run formatters
  ([`8d70138`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/8d701381c44e9f2be7abccbf82e984bec477df05))

### Continuous Integration

- Remove stale workflows
  ([`e870c76`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/e870c76f0d13555e11ded776cbfb99c2c6c5a5c7))

### Documentation

- **README**: Update badges
  ([`47b4093`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/47b4093c143bfb9e0edd85bbe49352c170ee1e9c))

### Refactoring

- Replace isort and black with ruff
  ([`b8a3f68`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/b8a3f68a9eb41062a15a6549798fe6fbbe4b6238))
...
- **poetry**: Update dev dependencies
  ([`b7db661`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/b7db661726499ebd5428a39c5f6c4b3cc7ad73b3))

### Chores

- Update funding links
  ([`8f7d555`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/8f7d55544521331fc27619a1bac985475e6a3d6e))

### Code Style

- Run formatters
  ([`0d5841b`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/0d5841b3542fdfe2f3dd2debe1308dadf6760ac3))

- Run formatters
  ([`ca0cc39`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/ca0cc398dd614ce6a1401f19d39e8ebc3dae76e1))

### Continuous Integration

- Update IDE config
  ([`9e20b34`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/9e20b345d09351d4e00aa190a470af9899680f2f))

- **pre-commit**: Update hooks
  ([`4d546f9`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/4d546f97511f02da196c79405af65071a8ae8536))

- **workflows**: Update poetry version
  ([`e15e416`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/e15e4169cb2843bd89f27a584d1ba086ad551db1))

### Documentation

- Update contribution guidelines
  ([`c1a3f0b`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/c1a3f0b06ca09d95ed339b3a1f5fb1b21b86754a))
...
- Update minimum required version of the poetry
  ([`5d9fdd5`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/5d9fdd534573b87651325a78e06060f94ccfc78e))
...
- **poetry**: Update dev dependencies
  ([`b2b7b0c`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/b2b7b0ceba8d310a59bb9a30b341e836f18dc7a1))

- **poetry**: Update dev dependencies
  ([`a775e76`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/a775e76153a78dcf3554f2ca7f43f9a4a7d2d843))

### Chores

- **pyright**: Update config
  ([`555afb3`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/555afb37f9048aad77f15a65e985b56675593d32))

### Continuous Integration

- **pre-commit**: Update hooks
  ([`38ba120`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/38ba120dc5682f9fa69d40af9b98ffb0d44b82cc))

- **workflows**: Remove forced patch release
  ([`4c216c9`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/4c216c9856961a9886178a6c86ba397b7ff49a53))
...
- Improve logging messages
  ([`698025e`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/698025e9680f4c766487a68a88370997bbff6dfa))

- Update copyright year
  ([`ace87c5`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/ace87c5f5e18f3baf4ec114b222015987c803522))

- **config**: Add correct handling of the bool values
  ([`f43d569`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/f43d569e8fa31a9e2e5e3f1f44a226e96db721a0))

- **dotenv.core**: Partially rollback optimization changes to resolve issue with overriding
  variables
  ([`661cbdd`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/661cbddc461b18a81148f6edf1eba331e6594739))
...
- **poetry**: Update dependencies
  ([`0087ef8`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/0087ef879c4aeda6136fd6e6cde9e544650026bc))

- **poetry**: Update dependencies
  ([`937a628`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/937a62819b682b7f96d8813bf587091d91082a77))

- **poetry**: Update dependencies
  ([`ddac174`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/ddac174dc4c42a3e89bbb4c324b07c99fe475084))

- **poetry**: Update dependencies
  ([`f4786d2`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/f4786d2f58f75f9cd4fb0fcf8629f64ed87969b4))

- **poetry**: Update dependencies
  ([`4f9b6e0`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/4f9b6e052255305022d56d663187afbd1a702f77))

- **poetry**: Update dependencies
  ([`9d9f500`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/9d9f500c7551352696b37508baa96130dfd70d1b))

- **poetry**: Update dependencies
  ([`501577c`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/501577c00c4e4ec89b7144bb14085cf95057ea53))

- **poetry**: Update dependencies
  ([`dae82e6`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/dae82e6b30a7da98d00ca6511ae02dfb362b6b65))

- **poetry**: Update dependencies
  ([`0cb00d9`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/0cb00d9f32d5c8a337d6967a61c339e58add1a3c))

- **poetry**: Update dependencies
  ([`4d0bea0`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/4d0bea050906ddd01854dccbad45fdcb38bb54e1))

- **poetry**: Update dependencies
  ([`0251507`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/025150726412dcf4a9e4d0ce1ceffed87a4c05b9))

- **poetry**: Update dependencies
  ([`8db5048`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/8db5048751005b272a13d432928b36a3166efc46))

- **poetry**: Update dependencies
  ([`9436341`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/9436341cdb4eb074dd52dd44d1e8a2065cb78e65))

- **poetry**: Update dependencies
  ([`38de93e`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/38de93e9ef0316164bafa56831193683b6f1fe11))

- **poetry**: Update dependencies
  ([`bd8403f`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/bd8403fced0b3a7e450e5421e6a71d138d88fe04))

- **poetry**: Update dependencies
  ([`a573752`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/a573752fefe063ded750fabee52745d72b98108f))

### Chores

- Remove `memestra`
  ([`27b89f5`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/27b89f544bda2c80f4f7d957c0008a17abf92085))

- Update IDE config
  ([`ca2c4ff`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/ca2c4ff2a6b04895efedd4161ed7050f82b74e10))

- Update tooling config
  ([`bbb1494`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/bbb14944a98d2150d53f09375eefe1029152d9aa))

- **codespell**: Update config
  ([`78208a3`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/78208a3c6cc8b9c1e47aa26588e4ceaf90548bb9))

- **cov**: Update exclusions
  ([`8ac8de6`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/8ac8de6ae2a8bff70371f59f355d966f8342c11e))

- **mypy**: Update config
  ([`e18cbd5`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/e18cbd5cc85faea0490a238e567e61a2d95d4dcc))

- **poe**: Remove `tests` task
  ([`bda2975`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/bda29757d8fc5cc0f2119ae48058ffb1d89c10ff))

- **poe**: Update `format` tasks
  ([`28c1b62`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/28c1b62dae86a5c8d91340d8fe4348a9e0cf2770))

- **poetry**: Add config
  ([`1bfaab3`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/1bfaab3b0f5746c41d450c58a5359f415f437542))

- **ruff**: Update config
  ([`94cb13d`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/94cb13d16e7cd3ace1ea948faf6c92ef9ec4137d))

- **ruff**: Update config
  ([`35e1cd1`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/35e1cd1d7537a6da12db5b23aa43324e0a39ce25))

- **ruff**: Update config
  ([`9a08cbf`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/9a08cbfb62448207543ff236f7c84a48fdc72ac0))

- **semantic-release**: Update config
  ([`d341707`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/d3417075be860dce43099fb397b2ab2f7f80056b))

- **semantic-release**: Update config
  ([`304fb92`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/304fb92c35049ffa45ef797963bcac53839b874f))

### Code Style

- Run formatter
  ([`7b6c0fb`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/7b6c0fbf9b050ecfc5424f49c6f67836e197a165))

- **examples**: Remove noqa suppressions
  ([`4642b31`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/4642b312bf7e48658d4623c93ae8dd9339a0dd99))

- **examples**: Update GIF theme
  ([`58aa83f`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/58aa83f5079c3437a9a38962781e1c72d86c6573))

- **labels**: Update formatting
  ([`7289c4c`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/7289c4c2a97571e16d113b3c41bf4988eedd2f20))

### Continuous Integration

- Add CodeCov config
  ([`a96844f`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/a96844f94c612f332f1317b2788c30a12d5b38bd))

- Update common IDE config
  ([`7d8d800`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/7d8d80092fa2bcb3b51628a80bd7dfeee92a4527))

- **actions**: Add action that setups env
  ([`9e733de`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/9e733dec7c4bf84689238e58d55bac8ea92aa746))

- **actions**: Add action that setups env
  ([`9c31e3a`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/9c31e3a5d25cbf50e22d742b1f1bd6b9d0dfffee))

- **actions**: Remove detect-changes
  ([`c4041a7`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/c4041a7a14d330d8cc202310a9c613066d2e55bd))

- **actions**: Remove setup-environment
  ([`2f254c2`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/2f254c2aa0a123281c4081f5ffeabe3ced059bd5))

- **actions**: Remove typo
  ([`4935a1e`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/4935a1e8d5932c43f1a5cb7fea9851a483ef29b1))

- **actions**: Rename actions
  ([`0d707b2`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/0d707b2b4e7b3f10f8f7b07187efad462e60fb0a))

- **actions**: Update action that setups environment
  ([`4b6b091`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/4b6b091b4f4d82420ac8080b3d2790efc7e7af0e))

- **actions**: Update anchors
  ([`5a1b39d`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/5a1b39d89ff6e0c383e7334586080f7708b17cea))

- **codecov**: Disable patch status
  ([`cf88fba`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/cf88fbaaf700ae06136c527253d8bd3e904ad19a))

- **dependabot**: Remove redundant configuration lines
  ([`fff7cf8`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/fff7cf87b66eb9c3dca7bf8eaaf83ff9d1cb050f))

- **dependabot**: Update labels
  ([`d081633`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/d08163380b56fbc2565692df9ae8e06d7608fcb4))

- **dependabot**: Update labels
  ([`f7dac3c`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/f7dac3cfe9316ac265a95ba05ca3860a28db8d08))

- **labels**: Update color fields
  ([`1f06a22`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/1f06a2201e3239be37410d050dc7673fad362853))

- **labels**: Update color fields
  ([`13529e4`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/13529e46cb9e226c8d10ca48f54840aa55085433))

- **labels**: Update description
  ([`861180c`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/861180cc2f7a2b9da2fd9878100ea43cc8a092c7))

- **labels**: Update description
  ([`6fb0b27`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/6fb0b272946044163fa494eac95ea7ccd11cd770))

- **pre-commit**: Remove `mypy` hook
  ([`4cb6ff4`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/4cb6ff42180bfc8280dc1aa10077ab6edd338f91))

- **pre-commit**: Update dependencies
  ([`af1eaaa`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/af1eaaa81827c3b06c6430e30f927fa9b86bea3f))

- **pre-commit**: Update hooks
  ([`45ce6b5`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/45ce6b52e4a158aeabb2cec5b16658a442272be5))

- **pre-commit**: Update hooks
  ([`f42835a`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/f42835a2b88a79f0a64647f64d8076b5d1ee7955))

- **pre-commit**: Update hooks
  ([`86307ed`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/86307edebf70747b0037aa3fd5b51f7ec47c4995))

- **pre-commit**: Update hooks
  ([`4399313`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/439931389935ef25767eb0eb545b7063de0b8ea2))

- **pre-commit**: Update hooks
  ([`065c67b`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/065c67bc63b0db15bf2842856101076875c053f6))

- **pre-commit**: Update hooks
  ([`e85fea7`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/e85fea79906d25b3cac44321cb3cf76c1c50f81a))

- **pre-commit**: Update hooks
  ([`d07f6ed`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/d07f6edfe8be4ff0d3d9af45e6ccbb51b8c690d2))

- **pre-commit**: Update hooks
  ([`a953122`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/a953122f98867ac1347ca266437b3f784b2dce72))

- **pre-commit**: Update hooks
  ([`443a5cb`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/443a5cb8557bbba111325a868b96e4affd33b0c0))

- **pre-commit**: Update hooks
  ([`34a19bb`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/34a19bb5a6f93a26b76c5af4300550a4f658c746))

- **pre-commit**: Update hooks
  ([`78284b6`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/78284b6609a5a76624e11ea5c32fddce82e74ec0))

- **pre-commit**: Update hooks
  ([`5ca1ac8`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/5ca1ac851a9e9d116062802a08a3edd7d7825de5))

- **pre-commit**: Update Python version
  ([`c29ffb9`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/c29ffb904c66f74f68f4ee3aa6ef7ff644bb8306))

- **workflows**: Add `name` field
  ([`b1453db`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/b1453dbcdd81c6eee29047624d31e3a5f3eb26b0))

- **workflows**: Add matrix for tests workflow
  ([`467f9a0`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/467f9a0ed022bc5886244f58772c0929f86b5f77))

- **workflows**: Add Python 3.13 into the testing grid
  ([`3984c90`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/3984c9050a910bd1ad6425b87c941ad6e7942630))

- **workflows**: Add workflow that locks PRs and issues
  ([`eed69ae`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/eed69ae3a0c76be512c9cbab6228e0c8562475fa))

- **workflows**: Add workflow that runs linters
  ([`6c949af`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/6c949afc91055b1d65f618590e126bc26404b187))

- **workflows**: Add workflow that runs tests
  ([`d8103b4`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/d8103b41c2006264e03fac2550087aab9159e17d))

- **workflows**: Add workflow that updates GitHub labels
  ([`0e2f6ca`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/0e2f6ca37a6b87150b3d88df3b2d762e843a797a))

- **workflows**: Add workflow that updates GitHub labels
  ([`96e587e`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/96e587e2600d83f0bdae6924e5194130786e4d5a))

- **workflows**: Lock version of the semantic-release
  ([`8a0f173`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/8a0f173819d0ee2f495d8da566dbac4beb32884d))

- **workflows**: Remove CICD workflows
  ([`14f4956`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/14f4956107060d1bdbc9d95e189755bb31cc68fe))

- **workflows**: Remove lockfile check
  ([`c4d02b8`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/c4d02b8a11293fcc01066b33c67d11152060f6c6))

- **workflows**: Remove MacOS x86_64 from the test matrix
  ([`34b7434`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/34b7434b41894426def77aeaad6becd40ea18f78))

- **workflows**: Remove schedule from the lock-threads
  ([`d3189ea`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/d3189ead88696eca722fb853990fc5503577c2c9))

- **workflows**: Remove step names
  ([`f2e4aba`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/f2e4aba8c107bf9b7f8a9f3a537a0ef28ce01346))

- **workflows**: Remove support of the Python 3.8
  ([`2d2627f`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/2d2627ff21f48436024e1445fb9589494b4605a9))

- **workflows**: Set force patch release
  ([`8823d2f`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/8823d2f80db7ad42fda4f07482fbcf43c9f637bb))

- **workflows**: Update CodeQL
  ([`127efc7`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/127efc750c5d3edce5f3f36a8e40854a4ff955a8))

- **workflows**: Update dependency review
  ([`3d4caf6`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/3d4caf6edc0897c76f9c310cd70a7dd9e0f5b2e3))

- **workflows**: Update IDs
  ([`1a2a255`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/1a2a255c661f57719e80874ba25d37f764f4d191))

- **workflows**: Update lock-threads comments for clarity
  ([`e860f1f`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/e860f1fcb4e57a017f85b9572c0684f93dce98a4))

- **workflows**: Update names
  ([`7470eb8`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/7470eb882870b512c693fbc4e8d84060e4b3e2e9))

- **workflows**: Update Poetry versions and add caching
  ([`d8c1e77`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/d8c1e7785d1a3e45ac9bc2c6d2b6a31297e285ab))

- **workflows**: Update Python version and add caching
  ([`82f973d`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/82f973d8cd9ea0ded376290ea308d2fe3fce8773))

- **workflows**: Update Python version to 3.13
  ([`fb4825f`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/fb4825f6169f841dc630a7d7919dfbf27bdda541))

- **workflows**: Update release workflow
  ([`6b2d9e5`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/6b2d9e5f53eb60ad020c7a50a1ef18d396629d4d))

- **workflows.release**: Add a flag to force release
  ([`972ac07`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/972ac079dfc9c89251765fa294c9c65add97d51b))

- **workflows.release**: Removed flag that forced release
  ([`9defea2`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/9defea28b034decf9887c64ec12dab52e90c4782))

### Documentation

- Update license
  ([`a1a437d`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/a1a437def6a6844e4ead9144901b3586904f4247))

- Update PyPI classifiers
  ([`5b314ab`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/5b314ab21c0b2747b8f856e4965f95642f45d174))

- **CHANGELOG**: Remove typo
  ([`bedc944`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/bedc94465c0e7f7a744a1b99290ac751ed474cf8))

- **CHANGELOG**: Update formatting
  ([`ad8653c`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/ad8653cc41fdd6e9f3df53a7149999297b100cba))

- **CODE_OF_CONDUCT**: Update formatting
  ([`da84834`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/da84834261b8f185f7d6f24568703741bed629ef))

- **CONTRIBUTING**: Improve clarity and consistency
  ([`58f9119`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/58f91195f345880bbfd7eef928d0daf38506935d))

- **CONTRIBUTING**: Update guidelines
  ([`eeca302`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/eeca302db2292522906c10d68d06a6395bfce40f))

- **LICENSE**: Update copyright year
  ([`bcf845b`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/bcf845bfa3a3ada182b47cf029493fb03602004c))

- **README**: Add preview of schema validation
  ([`8cc7a11`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/8cc7a11cde0e33e2de99202efd31219fa45158dc))

- **README**: Break parameters description in "Usage and Configuration" section
  ([`a28a864`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/a28a8641be50f3fecf2f01961ad8b314b4dae42b))

- **README**: Change headers level
  ([`2635741`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/26357417fbdf1e0e2ca58ac7d614fe5d49293fb1))

- **README**: Change headers level
  ([`882db03`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/882db03d8c808bd1219a167dc6c7c1f7573a4e8e))

- **README**: Update "Configuration via TOML file" section
  ([`bd071ca`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/bd071ca3dce549149d2ec0888123dc3f732a3a4d))

- **README**: Update "Features" section
  ([`b8987db`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/b8987db0061ae2c3a9d6ec33a712b206c783ae05))

- **README**: Update "Features" section
  ([`3d3fba8`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/3d3fba8563529ece15ef50aaf3a87db656574744))

- **README**: Update "Usage and Configuration" section
  ([`94eb3cf`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/94eb3cfa95a08b4c75af9028426b0fdcbdd58b24))

- **README**: Update badge colors
  ([`6c42db1`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/6c42db11148b44a309740e7999ce68581ef42982))

- **README**: Update badges
  ([`b4576d5`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/b4576d53ee1061fc8dc04492c090ad44ac5b3b6e))

- **README**: Update badges
  ([`50d752c`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/50d752c0278b305775b0d971ee626ebebda73776))

- **README**: Update badges
  ([`a89500b`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/a89500b33ebcc019e74f2f5a2b1766329f0aa394))

- **README**: Update badges
  ([`c88b2ef`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/c88b2ef66a0d96425238d249e49a2d36c1e48ceb))

- **README**: Update description of `location` parameter
  ([`99dde1c`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/99dde1c845db9bda4715e0670fb127156349625a))

- **README**: Update examples
  ([`d3c2989`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/d3c298973dd8adf4ab6d3f9aed7127b7a1538e96))

- **README**: Update examples
  ([`89c9c02`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/89c9c02889551794649d3e4ffa0a61f51691f00b))

- **README**: Update installation notes
  ([`640cbd6`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/640cbd683feebf4465f671bd3ba9f7f6952fbbaf))

- **README**: Update list of features
  ([`ff09909`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/ff099098e3ee3fb392da696e8fcffdd2da127c2c))

- **README**: Update notes
  ([`58f2d9a`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/58f2d9a4549a9fc9cf4a0afee80aa3b75b00bec0))

- **README**: Update TOC
  ([`696edc2`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/696edc29fdfd889798fd4a200fb66b78bfc8bef3))

- **TEMPLATES**: Improve clarity and consistency
  ([`581e9f2`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/581e9f2e72969f8bb57e3527e8b9aa768f3ed6d0))

- **templates**: Update issue templates
  ([`0b94904`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/0b94904978471c3963b0a8050f2a874a62d8a514))

- **templates**: Update PR template
  ([`de2b982`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/de2b9822be0cf9336969c9a88c2ee86c4bd82a21))

### Features

- Add back support of the poetry v1.5+
  ([`6dff21b`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/6dff21b5c511295cde09df304a675631b473df3a))

- Add module for custom exceptions
  ([`2247044`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/224704474f54b244879eea8552f75e9f41ddb4d7))

- Add support of `--directory`
  ([`3edd02c`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/3edd02c68a0452dee063de2be7c0d3752ec26942))

- Remove support of the Python 3.8
  ([`cd9380f`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/cd9380f77e3db90eec87d66401e9095bf90e708a))

- **poetry**: Downgrade `poetry` version
  ([`4bb8cb1`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/4bb8cb128764777f9dea3d6d55470404e9a4fe92))

### Refactoring

- Run linters
  ([`b692fbe`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/b692fbe3e871e0a5780992f6e6ccedfc490082a6))

- Update docstrings for clarity and consistency
  ([`cefb1e8`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/cefb1e80e771e075ee12fec5b20066974a0367b1))

- Update type annotations
  ([`d28e69d`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/d28e69d255a17eb3f6cda4f5fdd2a332b9b60ed0))

- **config**: Optimize code performance
  ([`9f8f1e9`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/9f8f1e9c4957c8e17008127a363ae4d20d5ae08c))

- **config**: Replace `pathlib` with `os.path`
  ([`578978b`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/578978b4481017b54f60be0e4bcafba0938eada6))

- **config**: Use empty string as `location` default value
  ([`d4d4f2d`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/d4d4f2dbb9517c95ba9ccc737c843613285a9b0c))

- **dotenv.core**: Add `nocover`
  ([`90fa484`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/90fa4843c8f84f68bc990f39c13bf377382d4915))

- **dotenv.core**: Optimize code performance
  ([`2e44007`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/2e44007fd0b089f678996d8edd6e055497e64af7))

- **dotenv.parsers**: Optimize code performance
  ([`121bdfd`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/121bdfd2718c0b829a4ae75634da22bd6441a2c1))

- **dotenv.parsers**: Remove stale `noqa`
  ([`a0fa85e`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/a0fa85ec9a18da51121819ae56fa87cd278fb12f))

- **dotenv.variables**: Optimize code performance
  ([`e648940`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/e6489405181b496da5b9e24c8b0196814b7f5a34))

- **logger**: Optimize code performance
  ([`103952d`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/103952d7a868dbfb6bce319adb5070edc416e9a2))

- **logger**: Reduce code duplication
  ([`34aaca8`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/34aaca89c074eef49a0547c4a7ca7de8aad516f5))

- **plugin**: Add `nocover`
  ([`45d373c`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/45d373c8a7b7895964547ca4fa816e6f8667b893))

- **plugin**: Optimize code performance
  ([`3eb31d8`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/3eb31d8d88eccc566037fd25734977c104a653f5))

- **tests**: Remove redundant docstrings
  ([`9511c1f`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/9511c1f6f744c671fe7e4d4bf00027122c44b3fd))

- **tests**: Run `ruff`
  ([`c974398`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/c9743980b3eb528583a804e8ab7647e286ce3c79))

### Testing

- Mock IO options
  ([`29f2cac`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/29f2cac68a323a2839956dd8bf16bc63281481f2))

- Split tests based on the config source
  ([`245c326`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/245c326a80bc05be435c42bfcdbace5f793198ee))
...
- **README**: Update list of features
  ([`f482c3a`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/f482c3aad72ad422540794228e3a13cb951cd73c))
...
- **assets**: Make logo transparent
  ([`2882bb0`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/2882bb04f64a906f6590f6a606d3c5b87284d368))
...
- **README**: Update badges order
  ([`8e3131a`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/8e3131a9abe920b8e74aa9b1a3799f934642c066))

- **README**: Update logo size
  ([`5199424`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/51994246a5ca066a14b722110e109c0023ee6b17))
...
- **assets**: Update logo colors
  ([`55943bb`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/55943bb380cd42b066aeba4bc2b60d3c43b3840a))

- **README**: Remove badges
  ([`acc067f`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/acc067ff232c0358daf008405164c1f9476bb164))
...
- **README**: Update logo
  ([`4315e21`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/4315e21fabc217152c8c996a32e1495f3348c734))

- **README**: Update logo
  ([`6170cfb`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/6170cfbdc6b01c0cc8a5eeee8f509b48ea76bdfb))
...
- **README**: Update demo
  ([`b710015`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/b71001596b1407307c1b870d3fe523a274a0ae9d))
...
- **pypi**: Update classifiers
  ([`03dcfe9`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/03dcfe961720be9288f475b4233088629a80d560))

### Chores

- **commitizen**: Update config
  ([`d02567f`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/d02567f9d619f4a3a879b89394ecde09add57247))

### Continuous Integration

- **workflows.cd**: Remove `force` flag
  ([`9c72e2a`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/9c72e2a27e6e76a57f11c78ea90c41ae7a22e206))
...
- **pre-commit**: Update dependencies
  ([`f89a7ee`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/f89a7ee5e963531d3ffda29bf25c16806339f3a2))

### Chores

- **semantic-release**: Update config
  ([`decaf2b`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/decaf2bc2fdc35faaad39e36fd65c746b9b0ce5e))

- **semantic-release**: Update config
  ([`8c24a1c`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/8c24a1cd6373645935cd43125fd330250bd5ef26))

### Continuous Integration

- **CHANGELOG**: Update unreleased notes
  ([`83bfd21`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/83bfd21ab4f7809f9f37bc4a0a884473bb235d15))

- **workflows.cd**: Lock `python-semantic-release` version
  ([`2d832e3`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/2d832e3c2e37809e21bfd6533d17931020cf96f4))

- **workflows.cd**: Temporary set `force` flag for the current release
  ([`a1b672e`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/a1b672e9145bc57f58562f7365820d41b3977ccf))

- **workflows.cd**: Unbound `python-semantic-release` version
  ([`5f26bed`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/5f26bed59a5bede7f2b66bef58171fa3ab976e12))

- **workflows.ci**: Add MacOS and Windows into the strategy for tests to run
  ([`fa900c6`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/fa900c67c0a697e5333c42ed1f1566b823d7e8b5))

- **workflows.ci**: Limit dependency installation for semantic release
  ([`9ada8be`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/9ada8be6ff18e2af9b04785cd4191d94ebcd7cf3))

- **workflows.ci**: Limit dependency installation for tests
  ([`6b94e96`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/6b94e966b6b6f83feedcb015df699e7f9c3abd22))

- **workflows.ci**: Remove `architecture` parameter
  ([`7ec8aa8`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/7ec8aa87d48dba2f19618fc1eb339194f4aa390b))

- **workflows.ci**: Remove Windows from the strategy for tests to run
  ([`7fb2780`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/7fb27805999a43784e0170cdb664cc8959ab2f3d))

### Features

- Move `Logger` into a separate module
  ([`cef85e3`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/cef85e39b1ebbcdab1a8b7ef5c7ff4598b66a268))

- **config**: Replace `tomli` with `tomlkit`
  ([`4381b66`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/4381b66dd68f56dcbdc0873649a8b647d5d3b385))

### Testing

- **plugin**: Replace mock of `tomli` with `tomlkit`
  ([`bb2781a`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/bb2781af214570727f74a0d8d39935c878e62452))
...
- **commitizen**: Update config
  ([`fae7c7d`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/fae7c7db27c03690c23a507f16fd129d0d6dbde6))

### Documentation

- Update demo example
  ([`3dd39b2`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/3dd39b2607c8f5be1589ada4f7ce6759a08477d4))
...
- **config**: Update attributes getter
  ([`efb09af`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/efb09af1661c6a7a645662a0a3fb56ce9ffadea0))
...
- **ruff**: Update config
  ([`b4438da`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/b4438da0b3354b1d391344a3db9901d21277aff9))

### Continuous Integration

- **workflows.ci**: Remove `macos` from tests strategy
  ([`3ab1777`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/3ab177785b1f7407688efd5f7e0342a7bacbdcb9))

### Documentation

- Add examples
  ([`d317fee`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/d317fee13e85f1a8d2faa715c475eb4f6a6949fe))

- **README**: Update `Usage` section
  ([`131731a`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/131731aa3f2c3902a0a64ca315da58e8e43a3e88))

- **README**: Update phrasing
  ([`563a809`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/563a809b5c156064096330de3d7ee9bd930130a3))
...
- Remove `Self` type annotation
  ([`61509d1`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/61509d13f4c48d5334c6e3b570dec97d56f19a3c))

### Testing

- **plugin**: Update section in `_toml_config` tests
  ([`be24ddb`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/be24ddbbf1a3ab0c9bb71a678a4701596dd6d663))
...
- **poetry**: Update dependencies
  ([`63739e3`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/63739e322a793679d5012956b3ba367ae284f84a))

- **poetry**: Update dependencies
  ([`54d82ee`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/54d82eedddef1c93a8fd36680b7f993d62ceb6c3))

- **pre-commit**: Update dependencies
  ([`669d2c2`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/669d2c2ae6d153a91a0e1c7c4de74a72799f0828))

### Chores

- **ruff**: Update config
  ([`edb588a`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/edb588a5d10c0cf5da47deeb9e57a8c8439bbdfe))

- **ruff**: Update config
  ([`024d25c`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/024d25cc6cce6b1c77d937b9c8499df21d1e514d))

### Code Style

- Add "no coverage" for `TYPE_CHECKING` sections
  ([`d7eaef6`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/d7eaef6448ca02254aeed8a2ff17c603275b9d14))

### Continuous Integration

- **.gitignore**: Add `.import_linter_cache`
  ([`4e4cd2f`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/4e4cd2f20de643d464caa02d3d46c993e4b83240))

### Documentation

- Add examples
  ([`a942ac3`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/a942ac3e61697cec2b09d7bd3c1767abedf547c6))

- **README**: Update badges
  ([`1d57d53`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/1d57d534ead0ada2cf1ce7d7b05bf53bc33891a7))
...
- **dotenv**: Update functions signatures
  ([`a6398ab`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/a6398ab65b68224703206e209760f8b40cf24bd9))

- **tests**: Update functions signatures
  ([`aeea0fc`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/aeea0fce02bcb1db3b6f631713b0a713d626b70e))

### Testing

- Update mocks in order to new configuration keys
  ([`1e0273c`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/1e0273cb00d0bbab4cb84c540df084b3b5165cfc))

- **config**: Add `test__as_bool`
  ([`2a71065`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/2a7106562204f14c91e544f8887017a7a4b84f28))

- **plugin**: Add `_toml_config` tests
  ([`1828af7`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/1828af75940a56582a8e76858d46e4da1ae67251))
...
- **codespell**: Update `ignore-words-list`
  ([`69cdbfb`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/69cdbfb1358882f5cd5b4029c790eedf97207e96))

### Documentation

- **README**: Update badges
  ([`d71aac0`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/d71aac0d19650ab1b93aae43e16c2aa3a6bf9798))
...
- Move VHS script
  ([`6d0308e`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/6d0308e585199936351ce81d64b4fe30b86c1fe8))
...
- **README**: Resovle issue with missing assets
  ([`9eb7fc4`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/9eb7fc4997ece57a445db3fcec599c556c9acba5))
...
- Update GitHub username
  ([`8651f6a`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/8651f6a31c12416a6c5c2baf857fdc5225148fb8))

- Update GitHub username
  ([`6cf3264`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/6cf32645405d57a648a0ccaa8160ac0c265bea3b))

### Build System

- **poetry**: Update dependencies
  ([`b8c3138`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/b8c31387d55068fea260b378661eed8862ee4902))

### Chores

- Move assets into own directory
  ([`7008802`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/700880257d5cee1c7ed8bb056d0dd227423678c6))

- Update keywords
  ([`b6b947a`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/b6b947ae6b8404715ae3e69475b7028165a07b6d))

### Continuous Integration

- Add Python 3.12
  ([`b22e0a2`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/b22e0a2bbaa1e438542766ee047545d029db9bee))

- Disable force version increment
  ([`47861c5`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/47861c54c0a16b171a6417ff3dc2c8581a035eb6))

- Remove pipeline that check stale branch
  ([`1201b57`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/1201b570a05a74e698db7b9fbf1c24583f318928))

- Remove pipeline that check stale PRs
  ([`92466e2`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/92466e238154556254c830af73a5f64ca6a03810))

- Update GitHub username
  ([`4377816`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/43778167d1a027245bd9c320c0dccf0f15db9561))

### Documentation

- Update badges
  ([`90578a8`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/90578a8b6d2609f6006c2718681b701680d5dccf))

- Update GitHub username
  ([`24bae26`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/24bae26da63eb8bc8dac0e701632ac9e9e1c877e))

- Update GitHub username
  ([`8d8edaf`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/8d8edafae0b74e182ed179af8c2cb63d508a0525))

### Features

- **README**: Update headers
  ([`9b136a7`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/9b136a7c6db896283592607381ec8e7d58441e8c))
...
- **poetry**: Add `commitizen`
  ([`31bb62e`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/31bb62eeead8bdf5222a73e901f62dab72d6baa5))
...
- **pre-commit**: Update dependencies
  ([`6d26f33`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/6d26f3382a41131117ba380b153c6f42a994b40a))

### Chores

- **commitizen**: Add config
  ([`72cae48`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/72cae48fedea8e018bd8e9f947ff46648938c015))

- **poe**: Add `commitizen` task
  ([`6291c34`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/6291c34a6d45e23d1edd61e1c7b2b813a6dc7cdd))

- **poe**: Add `lint-imports` task
  ([`fbc6146`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/fbc6146c59864a7179aca5a81bedfdddde516019))

- **poe**: Add `memestra` task
  ([`993e653`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/993e653a9e06cac0248209366e7f0a42b4d1ce70))
...
- **poetry**: Downgrade `pytest`
  ([`357c1d9`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/357c1d9c379753706ced64762b009ea30519ef9a))

- **poetry**: Remove `nitpick`
  ([`d0a1f2c`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/d0a1f2c695d65c3974300598c93574c11b1864b8))

- **poetry**: Update dependencies
  ([`e2c1f75`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/e2c1f75c53076aafef06b8fecd3e0dd5071eafe5))

- **pre-commit**: Update dependencies
  ([`0615700`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/0615700eff31e5bb356af99a88c88d311b1914d6))

### Chores

- **ruff**: Update config
  ([`4b60864`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/4b608646a879d41f3e552e117ef7836ae2991251))

### Code Style

- Run formatters
  ([`99bcf40`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/99bcf400692094c78b6bdba3df092e399d96a0a1))

### Continuous Integration

- **editorconfig**: Add TOML config
  ([`279af44`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/279af447b00d605405c6fb3eb921fd5ca1e3f650))
...
- **workflows**: Add workflow that checks stale PRs
  ([`7975292`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/79752920de12853cd1d951d8008f8890d5f0b35a))

- **workflows**: Add workflow that creates issues for branches that have become stale
  ([`1981046`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/1981046548e9e7d859ccef5a9ffeb4e9273ed98c))

- **workflows**: Update days before stale
  ([`782f693`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/782f6933fdbc790847d7c4bad65e12ef7b986c68))
...
- **CD**: Update `semantic-release` config
  ([`48114eb`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/48114eb4a90ed2ea8ab22dede830ba5692c06f33))

- **CD**: Update steps
  ([`4b9ec46`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/4b9ec46f9b9ce63d7b60f39db7957059c4c22370))
...
- Bump version
  ([`6781af6`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/6781af6601f0e0fd65ea2876a493ddcc9b8c51fd))

### Build System

- **codespell**: Update ignored files
  ([`7b27b48`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/7b27b486a2202a489ffade3e444150472de6593a))
...
- **poetry**: Remove `yesqa`
  ([`ed69eb6`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/ed69eb691a8d4385da0e34ad0d8c0345b825bc49))

- **poetry**: Update `python-semantic-release`
  ([`55fbf01`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/55fbf015da49b47eee17f8b9e3ba119cfa721bde))

- **poetry**: Update dependencies
  ([`11485fe`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/11485fef057332803d53589f1c5bf55a8718e4b4))

- **poetry**: Update dependencies
  ([`190ccb7`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/190ccb7f7c6c420ec9618212cd19fbbc4e3c1227))

- **poetry**: Update dependencies
  ([`dae6a80`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/dae6a80baaa72b4db0a8289b7c22d61374aac4ee))

- **pre-commit**: Update hooks
  ([`f4e39b1`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/f4e39b1fc82ae9e087d1e01973a40f5abdb442ad))

### Chores

- Add dependabot.yml config entry for github actions
  ([`3a9ef1b`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/3a9ef1b50495f9bf46a2da065fdbab1a967433d1))

- **deps**: Upgrade github actions
  ([`76fa660`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/76fa660e1581cf50c2c374f97d773b93f962dec8))

### Code Style

- Remove unused directive
  ([`c8d7bdc`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/c8d7bdced30600f5e204a23a79aee8d1be9b6b76))

- Update `mypy` ignore comments
  ([`bfb3905`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/bfb3905170ee7b2249b532378e52f21fcb28d5b8))

- **ruff**: Remove stale `noqa` comments
  ([`d241638`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/d241638d013ca640ec960ae61b6e2e0753413de8))

### Continuous Integration

- Update CD workflow
  ([`63c0eac`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/63c0eac8216a2ad5521fe21d0bae8302180c5395))

- Update CD workflow
  ([`a83b349`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/a83b349cc4607381caae04d7e090913b8baaba96))

- Update CD workflow
  ([`ce95f95`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/ce95f957582ce4ce92936d62feb67b7ad972a804))

- Update CD workflow
  ([`c3cf992`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/c3cf9928d8f31290723ac1cf9ad153bf1871c5ab))

- Update changelog
  ([`1b6a2e2`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/1b6a2e2d0bf47db46487900089ff4b232d458dfd))

- Update changelog
  ([`0419518`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/0419518a034dd0fdf027bc9f28cbf569fd455967))

- Update semantic release options
  ([`46a7342`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/46a7342b44bc5be841ff4c50939efea21fec15f9))

- **CD**: Remove build command
  ([`efa417b`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/efa417b1e16859134f6e399066dd281d5ac9031c))

- **hooks**: Update revisions
  ([`bf0d166`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/bf0d166edd5484513620413115242215217537fc))

### Documentation

- Update assets directory
  ([`20c3b70`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/20c3b70ebbfe616fb149b026d5f4c6bea427b67b))

- Update assets paths
  ([`65d1a9c`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/65d1a9cc9a97e52b66b62c8d5b16ce4921fcd3d3))

- Update contribution guideline
  ([`8b40105`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/8b401056ebc6462b352822f6a212ff4c4422d4ce))

- **README**: Add `poetry` badge
  ([`9ab93cf`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/9ab93cfa95b7609789c8ebd61c72587664a416e5))

- **README**: Add `pre-commit` badge
  ([`0f8208a`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/0f8208a93c92259e8b4a819fbf7d153357fc9f10))

- **README**: Update style of the GitHub stars badge
  ([`3261ce4`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/3261ce41cf8810410ab67a65bd68ad4458df6708))

### Features

- Bump version
  ([`f1f7690`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/f1f7690721a4374e7044800f00132d27f11e122a))
...
- Update `codespell` config
  ([`55ae479`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/55ae4791139ef65be324172322f312cb53ef9169))

### Code Style

- **docs**: Run formatters
  ([`3577088`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/35770883f8e306a706fb67ed51731e0b54190b36))

### Continuous Integration

- **CD**: Update `semantic-release`
  ([`4634a68`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/4634a683e3010656cf893fc95b7d4bd1cacb4a89))

- **pre-commit**: Add `deptry`
  ([`f6cf855`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/f6cf8556b593853af762f5d9671395cc77fa2087))

- **workflows**: Update trigger events
  ([`cbf4937`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/cbf4937a72d8d065a0ceae83896468623db69d49))

### Documentation

- **README**: Add "features" section
  ([`81873e9`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/81873e9a4716e3ad0cc156cd611992726d2ba52b))
...
- **poetry**: Update dependencies
  ([`cb5c2c9`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/cb5c2c99a6075ff8c9b699b31c854357553858bd))

### Continuous Integration

- **cd**: Add `twine`
  ([`e3fa8d5`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/e3fa8d53fbfb7e583fb1a1e5e35ba5d5de47d153))

- **pre-commit**: Update hooks
  ([`eb68d47`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/eb68d47460a53abb82c7ad8eb0b50f25d84a0f8b))

- **semantic-release**: Update `commit_auther`
  ([`fbfc1cb`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/fbfc1cb5f462249ad7e230c103a4fff685aaa1e6))

- **semantic-release**: Update parser options
  ([`0a0ee6f`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/0a0ee6f3634c524ad1d8a5c5ef49e5cf0dd6f368))

- **semantic-release**: Update TOML keys
  ([`a9dda42`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/a9dda42efb9cf609017fbe15189d520fb3a0e481))

### Documentation

- Add `wakatime` badge
  ([`18e460f`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/18e460fe6631f1219beff684f289b92ecb8ac9f8))

- Add `wakatime` badge
  ([`d0c39a7`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/d0c39a74343ee608587cc9cbcb52c9484bfa3573))

- Update badges
  ([`86a7716`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/86a771667cacbd3c3a011ee88e93773f702d70a2))
...
- **dependencies**: Update dependencies
  ([`309deb3`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/309deb3c6522eccb9e59c0903968462aeaacdb6a))

- **dependencies**: Update dependencies
  ([`a41d719`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/a41d71967089af7fedfd8961b8a674cb5237fcfa))

- **dependencies**: Update dependencies versions
  ([`99f87d7`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/99f87d789b2c18532c63f261c82e850485e82f33))
...
- Apply formatter
  ([`9bb3522`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/9bb352200bf3a57918b9959082d0b2313724be94))

### Continuous Integration

- Update classifiers
  ([`3bc4ce8`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/3bc4ce82fe19923e96cb0ed7421850e30c3b3e32))

- Update hooks
  ([`fefc88d`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/fefc88d576415290c09026d41b244e6031f3a5f0))

- Update ignored files
  ([`a535018`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/a53501814b2d47119e87f2bb2e68b46148af9ff7))

- **workflows**: Update secrets name
  ([`3ac00a7`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/3ac00a7368af111fcd87d6d733dc81ab89c4d558))

### Documentation

- Resolve invalid names
  ([`52be123`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/52be12367ad46c3d914db581c4e4657e49e512d0))

- Update badges
  ([`b88884a`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/b88884a11699a21489556b30ab8c666c772cc4c2))
...
- **docs**: Add demo
  ([`dfbf7a4`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/dfbf7a496c33ff4e652afb908ba542750ed85c5c))

### Continuous Integration

- **workflows**: Update secrets name
  ([`e80300f`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/e80300f29ef97c35c08dcacd237e87dddb2c4542))
...
- **dependencies**: Update versions
  ([`631990d`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/631990d927e623f3187bcda02eb1e79c3a9aa51a))

- **dependencies**: Update versions to the latest
  ([`a78bc99`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/a78bc99dbf010a5b5d58ebe402e383fff7541599))
...
- Exclude `poetry`
  ([`95ca78d`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/95ca78dfcec08b9856a8a31c49b9502ddd36caca))

### Features

- Rename plugin from `poetry-dotenv` to `poetry-plugin-dotenv`
  ([`6c28010`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/6c2801005a297a7738b139014c1239fa5fae2baa))
...
- Update annotations
  ([`dfa7a88`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/dfa7a88348a5f785d317d04e37bb3d86cbe78807))

### Build System

- Update configs
  ([`d493ea9`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/d493ea9a13c03b87fbbf880f532622d9b7916326))

- Update tasks
  ([`a0363ff`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/a0363ff7baebcdabe8d0641172827efcb11c4b4e))

- **dependencies**: Add `nitpick`
  ([`4da344d`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/4da344d9ff90d9c8b4ce0209ec855977c68b6c07))

- **dependencies**: Update dependencies
  ([`9142b77`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/9142b770222080a23b37f1f870c5162805af5151))
...
- Add GitHub labels
  ([`ab34487`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/ab34487812c52045a835d0b923d169ef15105544))

- Update annotations formatter
  ([`29eeb61`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/29eeb616d87bfaf040df9b6603485947710f0f5d))

- Update CD workflow
  ([`a438be2`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/a438be2ae26a099aff858a33156355e01459ddbf))

- Update CI workflow
  ([`7372342`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/7372342a158be6719054557e4716c2b145f15b04))

- Update CI workflow
  ([`ad2d12b`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/ad2d12b1cdfdf9e54354d9a2d707a8bd23e9f409))

- Update CodeQL workflow
  ([`57b3da3`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/57b3da3f3ae02e0f5191a4fb00c7520391ca51d9))

- Update Dependabot workflow
  ([`c4b840a`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/c4b840a30eab7f13c79c40ab48aa019a4e112851))

- Update hooks
  ([`d8924b8`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/d8924b8c2727aac1d0cbd779aa0583f73613bb21))

### Documentation

- Refactor changelog
  ([`9de0e0f`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/9de0e0f04b95b2eea9e437b3d2fa5d5c95618e6a))

- Update code of conduct
  ([`8a8ac6c`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/8a8ac6c049697ecf6aa87b9dea55f393e4db1ca9))

- Update contributing
  ([`4a82254`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/4a8225453370a4ca1bd678437861180db4d4f17f))

- Update license
  ([`33fa03c`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/33fa03c31859f53c2ad8eefae6c8dc764a338b90))

- Update README
  ([`155b5d1`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/155b5d168752ab5816e97ef9f76861d7a48da4ce))

- Update security notes
  ([`2d91876`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/2d918766f9432a3b85e49aef2111409193a5f070))

### Features

- **dependencies**: Add support of the Python 3.11
  ([`8cb07d2`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/8cb07d222fcd30cce61df864755189dbf48f5e63))

### Refactoring

- Update license
  ([`50cdd95`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/50cdd95bd05578216e0d4b20bef6a3080689a867))
...
- **docs**: Update docs
  ([`b9e4f83`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/b9e4f835104d14e09c0d7b3b67bebb5c5468504f))
...
- **dependencies**: Update base Python version
  ([`54d9c24`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/54d9c2449d9adb2ae01398f900c839623640cbf5))

- **dependencies**: Update dependencies
  ([`9bb1b31`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/9bb1b31aa4f3c1941f560d86cae7ddb5a6cd909c))

- **docs**: Update docs
  ([`68ae66b`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/68ae66b4655b2bce3ba30868818442eaf2197353))

### Documentation

- Update example
  ([`dcf96a2`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/dcf96a29c3a35f8a4566cacc13aa7b333d9ba254))
...
- **plugin**: Update logger
  ([`31a7d0a`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/31a7d0a454e7a87efb3cd635978725dbf06fe714))

### Build System

- **dependencies**: Update `pytest-sugar`
  ([`4ae7944`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/4ae794475db7ce18e87e0bdef8267ebd89bb7542))

- **dependencies**: Update dependencies
  ([`d6c0edd`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/d6c0edd8b286ef26583be952ad3ecf7a1a0e51f2))

- **dependencies**: Update dependencies
  ([`f0918b9`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/f0918b975ac33bdbe6e946b8a247178873a70e57))

### Continuous Integration

- **github**: Update workflows
  ([`84fe21d`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/84fe21db2e32d83b75da3dff2599cb99f1ff639f))

- **workflows**: Update `codeql` versions
  ([`8b7f052`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/8b7f0524640d91a99dbc1ea5b408f26ec2bf1417))

- **workflows**: Update actions version
  ([`5bf3488`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/5bf3488945fd1c3fdc85a6ae7453db04639f2458))
...
- Update classifier
  ([`0fb2a1e`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/0fb2a1eca03e5853b495b5668736209cb497bef0))

### Build System

- **dependencies**: Update dependencies
  ([`76e8eef`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/76e8eef9e1f81af8d3e59676a81a4704de50193f))

### Documentation

- Add examples
  ([`ec2d5b4`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/ec2d5b405ae0e74ea2e2ed2f7c13652432470894))

- Update docstrings
  ([`5a5bf90`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/5a5bf90447ed40454685014f0c850fa12213966a))

- Update examples
  ([`d2889aa`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/d2889aaea0484fc8ba6d6f09a9e3547614ebe806))

- Update toc
  ([`42101e9`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/42101e96771021ed4ef0b8927702c34c450d0a2c))

### Refactoring

- Update coverage
  ([`ab458ab`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/ab458abca3063f93e865ebdedbfde4cfb26ac29d))

- **docs**: Refactor
  ([`e3e5028`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/e3e5028a4d24c451d8ee595b456aff72915bf461))

- **docs**: Refactor
  ([`980e172`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/980e172b79c0531ccdda8a40424935e3ee640060))
...
- **plugin**: Add debug logger
  ([`01bf330`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/01bf330fad5a5253b71aec35bdc938446dcb04ea))

### Refactoring

- **CHANGELOG**: Resolve typos
  ([`c17f9e5`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/c17f9e5e2633a8feb046f49220733a09fd2b5f38))
...
- **plugin**: Resolve issue with debug entry
  ([`0714e00`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/0714e000b6287a19d19ed8c83717a7b1f39cdd88))

### Build System

- Add linters
  ([`526e816`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/526e81609f628808aaa81a7beda814acd56d3ae5))

- **dependencies**: Remove `pytype`
  ([`b3ce1a5`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/b3ce1a5a4d4087461a1a791c7201a763f05f5672))

### Continuous Integration

- Update CodeQL workflow
  ([`7b18285`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/7b182854815751cfb0c4ae1ac7e4e92127154835))

### Documentation

- **README**: Add overview section
  ([`b3956c7`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/b3956c74ae3c63af9b70f7ae20ac8653af478868))

- **README**: Remove LGTM badge
  ([`5faf034`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/5faf034e80f7c57a407124e0dbe6dd4d90517177))

- **README**: Remove redunant char
  ([`5941462`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/5941462eeabb9c92810c0c0ff90892faf54459b2))

### Refactoring

- **linters**: Update `mypy` task
  ([`f38365c`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/f38365c1be8a50eafed2eb6684acecd60ea3947a))
...
- **dotenv**: Add models of the variables/literals
  ([`af40eb2`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/af40eb2f64bd905c9ef06df76b6a68d1c4d5ef49))

- **dotenv**: Add parsers
  ([`4eac1a9`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/4eac1a96e7f9dc117c0bb3b497f6d788b0fd1f3d))

- **dotenv**: Resolve issue with `OrderedDict`
  ([`440171e`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/440171e5eb757d44ddd402d3fc21f085d3a0011a))

- **dotenv**: Update `OrderedDict`
  ([`13dabf2`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/13dabf2b175332ccb9a74dae5d3d0f87753af553))

- **dotenv**: Update base models to the `dataclasses`
  ([`9a61208`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/9a6120850bbb476a3dede57de64340f63320c9d3))

- **dotenv**: Update f-strings arguments
  ([`7ad2bfb`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/7ad2bfbca447cefd9dcae098bf93bfe6c57e27ed))

### Build System

- Add `pyupgrade`
  ([`ef11be2`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/ef11be2a54cf5fa9603fb03eefc6f3c52d583def))

- Remove unnecessary package
  ([`9b4d07d`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/9b4d07dedc4a39ae0751d6bbd4e9e60171753e58))

- Update groups
  ([`b12fc13`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/b12fc13b8e2ece8a93cfee6b63ce25972016b379))

- Update versions
  ([`8e8ea80`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/8e8ea80536fa4ad0ad120f71f66ab5c6e17ac76f))

- **dependencies**: Add `sh` package
  ([`b542bf8`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/b542bf8d72b2df7a485f4811bf24b4c992a03b3f))

- **dependencies**: Add linters
  ([`09f3d96`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/09f3d96f08848dc61c1c1f34f56a7827ad39105f))

- **dependencies**: Remove `poe` plugin
  ([`0641de3`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/0641de3f4b99f5d1ae7a1c61ce2fb84fa414bba0))

- **dependencies**: Remove unnecessary package
  ([`59da623`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/59da62317046845212c241427126a08aacbf1e15))

- **tasks**: Add linter tasks
  ([`870ae7b`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/870ae7ba30e8789a3014689c603c04a8ddb01f05))

### Chores

- Add returns
  ([`134909f`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/134909fe1a011b18cb308554bd2bb69eb8488197))

- Reset
  ([`a7123db`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/a7123db2a2978ce060872a8d0d3c375ea52eee88))

- Reset
  ([`8a243a3`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/8a243a30bf725bb33f1f2094c0b05116ab024c38))

- Update exclusions
  ([`57c91a3`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/57c91a367c74321a131ea9cb30ff9fa8f051f517))

- **dotenv**: Add skeleton of the core
  ([`0ea787a`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/0ea787ae6fe5e99cc8566c9ccac78bead8b7558a))

- **flake8**: Update exclusions
  ([`a2701ee`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/a2701ee6f4a7f62048e11dd08d24b306a65a2292))

- **flake8**: Update exclusions
  ([`d75fd94`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/d75fd9400e7f95f5e09c57242eac3a74033ba2cf))

- **flake8**: Update exclusions
  ([`88f0361`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/88f03610e9ce15efafadbd58295471832c501024))

- **flake8**: Update exclusions
  ([`9c03e19`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/9c03e19f4a2e73e71549e0661834e54933ad86c5))

- **flake8**: Update exclusions
  ([`e0b69cb`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/e0b69cb97326cea7236ee40371c6c373bf18faac))

- **mypy**: Add tests dir
  ([`7b80be9`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/7b80be992f167e6d0cd55d9190d69335e319f14f))

- **mypy**: Update target version
  ([`cfd95ed`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/cfd95ed1660a05d7c70c7f11e1abf4a12ff292db))

### Continuous Integration

- **cd**: Remove slack notifications
  ([`818c5b0`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/818c5b00193fc8f3678bb95c52dda92347df352a))

- **cd**: Update twine entrypoint
  ([`1e6156b`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/1e6156b397cd9678014c01841387d6ed608fcc60))

- **docs**: Remove `readthedocs` config
  ([`5f2ed59`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/5f2ed59151e9610dc899036de83cff7abfd7744d))

- **pre-commit**: Remove `pyupgrade` hook
  ([`e1e1f21`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/e1e1f21918b2e184009aa7b53cdf56983e1f8641))

- **workflows**: Update OS
  ([`05e13f9`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/05e13f9115eca4699b623abdc8b751267f5e4c9f))

### Documentation

- Add logo
  ([`cd589d1`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/cd589d1faf8922bb49d56f7cc853be578a47f6d5))

- **docstrings**: Update docstrings
  ([`168c692`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/168c692d60914c1c8eda91de84c905701918ce69))

- **github**: Format changelog
  ([`d3d9a4f`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/d3d9a4f976a744149b80d6fe9c34500937bacbfb))

- **github**: Format changelog
  ([`40ff2fa`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/40ff2fa841eb5f5285fb67b755f9ffd92891cc71))

- **github**: Format contributing guide
  ([`8bbfa71`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/8bbfa71a7bedcbfd327bedcdd1827283db978a9a))

- **github**: Format security
  ([`edac82a`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/edac82aacd95f89638e052bac9ff7a602cd040f6))

- **github**: Format template of the feature request
  ([`01b860c`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/01b860cce86bc54caa9a7a3e3ee366ff1171eaef))

- **github**: Update homepage
  ([`2eaec85`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/2eaec858eccda8084b66e22a3657ea1551d72663))

- **github**: Update homepage
  ([`4b21426`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/4b21426e4e6a7c42404d987281e97ff6a36609ed))

- **github**: Update homepage
  ([`c9d9885`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/c9d9885e371bba74aa35d239a8f9003e0a14bddf))

- **github**: Update template of the bug report
  ([`e93452f`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/e93452ffebf1f07eb141e9d6874c39a1681a5328))

- **github**: Update template of the bug report
  ([`cc2beb3`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/cc2beb3f63e3c66335899c17c4537907c745fb19))

- **github**: Update template of the feature request
  ([`d07233f`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/d07233ff24fe154e9e5e9466d86779536dbd36d4))

- **plugin**: Update docstrings
  ([`fd57094`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/fd57094b4bb063ed297cac94e22118a9123df5ff))

### Features

- **dotenv**: Add core
  ([`2ce7dcf`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/2ce7dcf294bc3cb2de05f5894d6eda00292a4c4e))

- **dotenv**: Add core IO functionality
  ([`8398fdd`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/8398fdd76ce7c544a1bcb0838a69c0dcc0cc0055))

- **dotenv**: Add core IO functionality
  ([`d2923d5`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/d2923d5b7d8d2d2ac15d5b8f381ed83964c3430a))

- **dotenv**: Add parsers
  ([`b338ecb`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/b338ecbd1c9d647b01fd3a14803378b0a1748315))

- **plugin**: Add core dotenv functionality
  ([`2da6bf1`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/2da6bf193269f283cad477eddce39fef8ef8a991))

### Refactoring

- Refactor
  ([`c0eb76e`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/c0eb76e7b6e6e6eae80bd663e922f9af6219715d))

- Refactor
  ([`5c0f9cd`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/5c0f9cd5dad889360b0d872fcc5b813f41065352))

- **changelog**: Refactor
  ([`733c3ab`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/733c3abf0b3a79d10b1b0d72d9e96396a68c1a2e))

- **docs**: Refactor
  ([`0212bcb`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/0212bcbd9abd02cfe1dd175f6c62f7c5a67905cb))

- **dotenv**: Refactor
  ([`d335bb9`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/d335bb97cc956c80b55ec4f1ca0745e85dd87f06))

- **dotenv**: Refactor
  ([`066ace2`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/066ace2accc73f7c029ffda0b1b69aa6e794e235))

- **plugin**: Refactor
  ([`a701534`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/a701534f788e103be17c8cb29265002c922910de))

- **plugin**: Remove outdated logic
  ([`7f034bc`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/7f034bc542118ee018a603a462ee05bf8cbad4e0))

- **tests**: Fix grammar mistakes
  ([`07ecbd7`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/07ecbd7e9f2a400f931f7d6d32bda7f90a2b28f9))

- **tests**: Refactor
  ([`0a1af8e`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/0a1af8e23805f55e5ef95caa90b6a3b9e4611004))

### Testing

- **dotenv**: Add dotenv file fixture
  ([`ec4f1c9`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/ec4f1c9ff4cbb0a2ae96f4e792f4415c89eebce6))

- **dotenv**: Add missing tests
  ([`3d56a2b`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/3d56a2b5e2cb918d4a634ca523e6a7328159b5f8))

- **dotenv**: Add tests for core IO functionality
  ([`d15114e`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/d15114eb7b1ac406d95aa0469845a883c6ca6fc6))

- **dotenv**: Add tests for parsers
  ([`1d23322`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/1d23322919a0b4bfa24c7ffb689814585170f2dd))

- **dotenv**: Add tests for variables/literals
  ([`ae1b782`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/ae1b7823e92728417a3f41ef6521e31ba4016692))

- **plugin**: Add cleanup
  ([`1705bcc`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/1705bcce728d9e95e53812a077a1250738c0831b))

- **plugin**: Fix issue with fixtures
  ([`d9cdd9d`](https://github.com/pivoshenko/poetry-plugin-dotenv/commit/d9cdd9d43cc7929cf8e39ac92801317594283c09))
