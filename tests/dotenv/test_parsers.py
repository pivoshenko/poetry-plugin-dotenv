...
@pytest.mark.parametrize(  # noqa: PT014
    argnames=("test_input", "expected"),
    argvalues=[
        ("", []),
        (
            "a=b",
            [Binding(key="a", value="b", original=Original(string="a=b", line=1), error=False)],
        ),
        (
            "'a'=b",
            [Binding(key="a", value="b", original=Original(string="'a'=b", line=1), error=False)],
        ...
        (
            "[=b",
            [Binding(key="[", value="b", original=Original(string="[=b", line=1), error=False)],
        ),
        (
            " a = b ",
            [Binding(key="a", value="b", original=Original(string=" a = b ", line=1), error=False)],
        ...
        (
            "# a=b",
            [Binding(key=None, value=None, original=Original(string="# a=b", line=1), error=False)],
        ),
        (
            "a=b#c",
        ...
        (
            "a=à",
            [Binding(key="a", value="à", original=Original(string="a=à", line=1), error=False)],
        ),
        (
            'a="à"',
            [Binding(key="a", value="à", original=Original(string='a="à"', line=1), error=False)],
        ...
        (
            "a: b",
            [Binding(key=None, value=None, original=Original(string="a: b", line=1), error=True)],
        ),
        (
            "a=b\nc=d",
            [
...
def test_parse_stream(test_input: str, expected: List[Binding]) -> None:
    ...
    # PT014 - there are no duplicated test cases
