...
- Module docstrings open with `Module that contains ...`; `__init__.py` opens with `Package that contains ...`. Test modules read `Module that contains tests for ...`, which nests when the module under test is itself described that way.
